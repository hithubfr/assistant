...
**Proposition d’action immédiate :** créer l’issue ci‑dessus (labels suggérés : documentation, enhancement) et proposer un canevas de PR pour appliquer les modifications (sommaire + checklist + lien vers la release). Je peux aussi préparer directement une PR contenant ces changements si vous préférez.
